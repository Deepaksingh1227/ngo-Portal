        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            ...
            <p className="fs-6 text-muted">
              ...
              <strong> Sardar Kartar Singh Jhabbar Khalsa</strong>, is that every beneficiary must live as a 
            ...
            <p className="fs-6 text-muted">
              Through this Trust, we continue what <strong>Sardar Kartar Singh Jhabbar Khalsa</strong> began — 
